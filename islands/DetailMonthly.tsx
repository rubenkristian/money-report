        ...
        <div class="flex flex-col gap-3">
          <div class="flex flex-col gap-2">
            ...
            <input
              ...
              id="date"
              type="date"
              class="h-8 border rounded-sm w-full"
            />
          </div>
          <div class="flex flex-col gap-2">
            ...
            <textarea
              ...
              id="desc"
              class="h-32 border rounded-sm w-full"
            />
          </div>
          <div class="flex flex-col gap-2">
            ...
            <select
              value={status}
              onChange={(e) =>
                setStatus(Number((e.target as HTMLSelectElement).value))}
              id="status"
              class="h-8 border rounded-sm w-full"
            >
          ...
          <div class="flex flex-col gap-2">
            ...
            <select
              value={type}
              onChange={(e) =>
                setType(Number((e.target as HTMLSelectElement).value))}
              id="type"
              class="h-8 border rounded-sm w-full"
            >
          ...
          <div class="flex flex-col gap-2">
            ...
            <input
              value={cash}
              onInput={(e) =>
                setCash(Number((e.target as HTMLInputElement).value))}
              id="cash"
              type="number"
              class="h-8 border rounded-sm w-full"
            />
          ...
          <button
            class="w-full bg-[#38bdf8] text-white p-2 rounded-sm"
            onClick={() => saveDetailMonthly()}
          >
            {id ? "Update" : "Save"}
          </button>
        </div>
